...
class InstrumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instrument" do
    assert_difference("Instrument.count") do
      post instruments_url, params: { instrument: { brand: @instrument.brand, color: @instrument.color, condition: @instrument.condition, description: @instrument.description, model: @instrument.model, price: @instrument.price, title: @instrument.title } }
    end
  ...
  test "should update instrument" do
    patch instrument_url(@instrument), params: { instrument: { brand: @instrument.brand, color: @instrument.color, condition: @instrument.condition, description: @instrument.description, model: @instrument.model, price: @instrument.price, title: @instrument.title } }
